...
if(isset($_POST["btn_login"]))
{
	...
	$query = mysqli_query($connection,"select * from ats_vendor where ats_vendor_username ='".$user_name."'");
	$row = mysqli_fetch_array($query);
	
	if($row ["ats_vendor_username"] == $user_name && $row ["ats_vendor_password"] == $user_password)
	{
        $_SESSION['vendor_name'] = $row['ats_vendor_bussiness_name'];
        $_SESSION['vendor_id'] = $row['ats_vendor_id'];
		header("Location:index.php");
	}
	else
	{
                    ...
                    <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            ...
                            <h4 style="margin-top: -4%;" class="mb-0">
                                <span class="d-block">Welcome Again</span>
