...
include("connection_db.php");
    ...
    $queryreserved_search="select * from ats_stock_reservation where sold_status<>'' AND sold_status BETWEEN '$get_reservedreports_date' AND '$get_reservedreports_till' ";
