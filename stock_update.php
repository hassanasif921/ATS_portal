                                                ...
                                                <div id="step-1">
                                                    ...
                                                    <div id="step-3">
                                                        ...
                                                        <div class="form-row"> 
                                                            ...
                                                            <div class="col-sm-2">
                                                                    <div class="position-relative ">
                                                                        <input type="text" id="stock_eta" name="stock_eta" placeholder="ETA" class="form-control-sm form-control" value="<?php echo $rowupdate[125]?>">
                                                                    </div>
                                                                </div> 
                                                            <div class="col-sm-2">
                                                                <div class="position-relative ">
