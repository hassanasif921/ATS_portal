                        ...
                        <div style="margin-left: -18px; margin-right: -53px;" class="container">
                            ...
                            <div class="card-body">
                                <form action="" method="">    
                                    ...
                                    <div class="row">       
                                        <div style="margin-left: -10px; width: 104.7%;" class="container" id="table2">
                                            ...
                                            <div style="height: 190px; margin-top: -12px; overflow: auto;" class="tab-content" id="table1">
                                    ...
                                    <div style="margin-left: 1%;" class="row mt-1 nav nav-justified" id="table">
                                        <div class="nav-item">
                                            ...
                                            style="width: 120px;" class="btn-pill btn-shadow btn-wide mt-0 mb-2 btn btn-primary" value="Reserve Car" type="button">
                                        </div>
                                        <div class="nav-item">
                                            <input data-toggle="modal"
                ...
                <div class="modal-body">
                    <div class="row">
                        <div style="margin-top: -3%;" class="col-md-12">
                            <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row[69]);?>" class="img-fluid">
                        </div>                          
                    </div>
                </div>   
            </form>
        ...
        <div class="modal-content">
            ...
            <form>
                <div class="modal-body">
                    <div class="row">
                        <div style="margin-top: -3%;" class="col-md-12">
                            <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row[72]);?>" class="img-fluid">
                        </div>                          
                    </div>
                </div>   
            </form>
        ...
        <div class="modal-content">
            ...
            <form>
                <div class="modal-body">
                    <div class="row">
                        <div style="margin-top: -3%;" class="col-md-12">
                            <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row[77]); ?>" class="img-fluid">
                        </div>                         
                    </div>
                </div>   
            </form>
        ...
        <div class="modal-content">
            ...
            <form>
                <div class="modal-body">
                    <div class="row">
                        <div style="margin-top: -3%;" class="col-md-12">
                            <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row[90]); ?>" class="img-fluid">
                        </div>                          
                    </div>
                </div>   
            </form>
        ...
        <div class="modal-content">
            ...
            <form>
                <div class="modal-body">
                    <div class="row">
                        <div style="margin-top: -3%;" class="col-md-12">
                            <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row[85]); ?>" class="img-fluid">
                        </div>                          
                    </div>
                </div>   
            </form>
        ...
        <div class="modal-content">
            ...
            <form>
                <div class="modal-body">
                    <div class="row">
                        <div style="margin-top: -3%;" class="col-md-12">
                            <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row[88]); ?>" class="img-fluid">
                        </div>                          
                    </div>
                </div>   
            </form>
        ...
        <div class="modal-content">
            ...
            <form>
                <div class="modal-body">
                    <div class="row">
                        <div style="margin-top: -3%;" class="col-md-12">
                            <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row[95]); ?>" class="img-fluid">
                        </div>                          
                    </div>
                </div> 
            </form>
