...
?>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-md-3">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <div style="margin-bottom:-16px;" class="form-row">
                                                                            <div class="col-sm-2">
                                                                                <input  type="text" class="" value="ATS-" style="font-size:18px;border:none;margin-top:3px" d disabled>
                                                                            </div>
                                                                            <div class="col-sm-10">
                                                                                <input name="emp_id_ag" id="emp_id_ag" type="text" class="form-control" value="<?php echo $rowemp['Auto_increment']; ?>"required>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <p id="plsinsertpno" style="color:red;text-decoration:bold;display:none">Please insert Phone </p>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <input type="text"  class="form-control" name="emp_date_of_birth" id="emp_date_of_birth" />
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="emp_cnic_expiry" id="emp_cnic_expiry" />
                                                            ...
                                                            <div class="col-md-4">
                                                             ...
                                                             <div class="col-md-6">
                                                                <div  class="position-relative form-group">
                                                                    ...
                                                                    <input name="emp_username" id="emp_username" value="<?php echo"UN",(rand(100,1000000));?>" type="text" required  class="form-control">
                                                                </div>
                                                            </div>
                                                             <div class="col-md-6">
                                                                <div  class="position-relative form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div  class="position-relative form-group">
                                                                    <label>Photo <span style="font-size: 11px; color: grey;">(Please Upload Passport Size Picture)</span></label>
                                                                    <input name="emp_passport_image" id="emp_passport_image" type="file" onchange="loadFile(event)" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    <label>CNIC <span style="font-size: 11px; color: grey;">(Please Upload CNIC Picture Front and Back side)</span></label> <br/>
                                                                    <input  multiple="multiple" name="file[]" id="emp_cnic_pic_both_side" type="file" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    <label>Residential Docs <span style="font-size: 11px; color: grey;">(Please Upload Picture of Utility Bills)</span></label>
                                                        ...
                                                        <div class="form-row">
                                                           ...
                                                           <div class="col-md-4">
                                                            <div class="position-relative form-group">
                                                                ...
                                                                <p id="plsinsertename" style="color:red;text-decoration:bold;display:none">Please insert Name</p>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <p id="plsinsertephone" style="color:red;text-decoration:bol;display:noned">Please insert Phone #</p>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <p id="plsinserterelation" style="color:red;text-decoration:bold;display:none">Please insert Relation</p>
                                                                ...
                                                                <div data-parent="#accordion" id="collapseTwo"
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="form-row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                        <div  class="position-relative form-group">
                                                                                            <label>Educational Docs <span style="font-size: 11px; color: grey;">(Pleaes Upload Educational Docs)</span></label>
                                                                                            <input  multiple="multiple" name="fileedu[]" id="emp_edu_docs" type="file">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-4">
                                                                                        <div  class="position-relative form-group">
                                                                                            <label>Experience letter Docs <span style="font-size: 11px; color: grey;">(Pleaes Upload Experience letter)</span></label>
                                                                                            <input  multiple="multiple" name="fileexp[]" id="emp_exp_docs" type="file">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-4">
                                                                                        <div class="position-relative form-group">
                                                                                            <label>Other Docs <span style="font-size: 11px; color: grey;">(Pleaes Upload Other docs)</span></label>
                                                                        ...
                                                                        <div class="form-row">
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <div class="position-relative form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control" id="emp_date_of_joining" name="emp_date_of_joining" required />
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                <div class="position-relative form-group">
                                                                                        ...
                                                                                        <select name="emp_payroll" id="emp_payroll" class="form-control" required required>
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                <div class="position-relative form-group">
                                                                                    ...
                                                                                    <input name="emp_basic_salary" id="emp_basic_salary" placeholder="Enter Basic Salary" type="text" required class="form-control" required>
                                                                                    <p id="salary" style="color:red;text-decoration:bold;display:none">Pls Fill out these fields</p>
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                <div class="position-relative form-group">
                                                                                    ...
                                                                                    <input name="emp_profit_share_percentage" id="emp_profit_share_percentage" placeholder="Enter Profit Share %" type="text" class="form-control" required>
                                                                                    <p id="profit" style="color:red;text-decoration:bold;display:none">Pls Fill out these fields</p>
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                <div class="position-relative form-group">
                                                                                    ...
                                                                                    <input name="emp_commision_per_unit" id="emp_commision_per_unit" placeholder="Enter Commission / Unit" type="text" class="form-control" required>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-3">
                                                                                <div class="position-relative form-group">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="position-relative form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control" name="emp_last_working_date" id="emp_last_working_date"/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div style="font-family: Arial, Helvetica, sans-serif; border: 3px solid #ff9900; " class="card mb-4">
                                                                        <div style="height: auto; padding-top: 1%; padding-bottom: 1%; background: linear-gradient(135deg, #ff9900 0%, #ffff 100%)" class="card-header">
                                                                            <div  class="media flex-wrap w-100 align-items-center">
                                                                               ...
                                                                               <div>
                                                                                <label for="email"><a style="color: black;text-transform:lowercase;" id="emp_email_print"  href = "javascript:;" onclick = "this.href='mailto:' + document.getElementById('emp_email').value"></a>&nbsp;&nbsp;</label><br/>
                                                                                <label for="doj"><span style="color: black;text-transform:lowercase;" id="emp_doj" ></span>&nbsp;&nbsp;</label><br/>
                                                                                </div>
                                                                              
                                                                                 <img src="assets/images/logo-inverse2.png" /> 
                                                                        ...
                                                                        <div class="card-body ">
                                                                            <div class="row ">
                                                                                ...
                                                                                <div style=" margin-top: 0.5%;" class="col-md-6">
                                                                                    ...
                                                                                    <label for="timing">Timing : <span style="font-weight: bold;" id="emp_timing_print" ></span></label><label for="timing1">&nbsp;To&nbsp;<span style="font-weight: bold;" id="emp_timing_print" ></span></label><br/>
                                                                                ...
                                                                                <div id="dvPreview" class="col-md-12">
                                                                                    ...
                                                                                    <label style="padding-top: 9px;">Educational Documents : </label><br/>
                                                                                    <div id="dvPreviewedu" class="col-md-12">
                                                                                    </div>
                                                                                    <label style="padding-top: 9px;">Experience Letter :</label><br/>
                                                                                    <div id="dvPreviewexp" class="col-md-12">
                                                                                    </div>
                                                                                    <label style="padding-top: 9px;">Other Documents :</label><br/>
  ...
  $(document).ready(function(){
    $('#emp_status').on('change', function() {
      ...
      //.....................^.......
      {
        $("#emp_last_working_date").show();
      }
      else
      {
        $("#emp_last_working_date").hide();
      }
    });
});
...
function myFunction() {
    ...
    {
     $("#plsinsertfname").toggle();

    }
    if(emp_last_name.value == "" )
    {
     $("#plsinsertlname").toggle();
    ...
    if(emp_city.value == "" )
    {
     $("#plsinsertcity").toggle();

    }
    if(emp_state.value == "" )
    {
     $("#plsinsertstate").toggle();
    ...
    if(emp_date_of_birth.value == "" )
    {
     $("#plsinsertdob").toggle();

    }
    if(emp_place_of_birth.value == "" )
    {
     $("#plsinsertpob").toggle();

    }
    if(emp_nationality.value == "" )
    {
     $("#plsinsertnationality").toggle();

    }
    if(emp_cnic_no.value == "" )
    {
     $("#plsinsertcnic").toggle();

    }if(emp_cnic_expiry.value == "" )
    {
     $("#plsinsertcnicexpiry").toggle();

    }
    if(emp_email.value == "" )
    {
     $("#plsinsertemail").toggle();

    }
    if(emp_relationship_status.value == "" )
    {
     $("#plsinsertrstatus").toggle();

    }
    if(emp_gender.value == "" )
    {
     $("#plsinsertgender").toggle();

    }
    if(emp_emergency_contact_person_name.value == "" )
    {
     $("#plsinsertename").toggle();

    }
    if(emp_emergency_contact_person_phone.value == "" )
    {
     $("#plsinsertephone").toggle();

    }
    if(emp_emergency_contact_person_relation.value == "" )
    {
     $("#plsinserterelation").toggle();

    }
    if(emp_institute_name.value == "" )
    {
     $("#plsinsertiname").toggle();

    }
    if(emp_degree.value == "" )
    {
     $("#plsinsertdegree").toggle();

    }
    if(emp_degree_year.value == "" )
    {
     $("#plsinsertdyear").toggle();

    }
    if(emp_degree_status.value == "" )
    {
     $("#plsinsertdstatus").toggle();

    }
    if(emp_designation.value == "" )
    {
     $("#designation").toggle();

    }
    if(emp_department.value == "" )
    {
     $("#department").toggle();

    }
    if(emp_date_of_joining.value == "" )
    {
     $("#dof").toggle();

    }
    if(emp_payroll.value == "" )
    {
     $("#payroll").toggle();
...
$("#emp_date_of_joining").change(function() {
