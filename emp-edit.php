...
if (isset($_POST["btnsubmit"])) {
    ...
    if($totalfiles!=0){
        $insertdel = "delete FROM employeecnic WHERE image_type='NIC-Pic' AND ats_emp_id=".$id;                   
    ...
    for($i=0;$i<$totalfiles;$i++){
        ...
        if(move_uploaded_file($_FILES["file"]["tmp_name"][$i],'upload/'.$filename)){
            ...
            $iquery1 = mysqli_query($connection,$insert1);
        }       
        else{
    ...
    if($totalfilesres!=0){
        ...
        $rquerydel2 = mysqli_query($connection,$insert2del);
    }
    ...
    if($totalfilesedu!=0){
        ...
        $equerydel3 = mysqli_query($connection,$insert3del);
    }
    ...
    if($totalfilesexp!=0){
        ...
        $exquerydel4 = mysqli_query($connection,$insert4del);
    }
    ...
    if($totalfilesother!=0){
        ...
        $othquerydel5 = mysqli_query($connection,$insert4del);
    }
    ...
    if(is_uploaded_file($_FILES['emp_passport_image']['tmp_name'])){
        ...
        ,ats_employee_status='$emp_status',ats_employee_lastWorkingDate='$emp_last_working_date',region2='$emp_region2',region3='$emp_region3',region4='$emp_region4',region5='$emp_region5',emp_timing_till='$emp_timing1',username='$emp_username',password='$emp_password' WHERE ats_employee_id='".$id."'";
        ...
        $insert = "UPDATE ats_employee SET ats_employee_firstName='$emp_first_name',ats_employee_middleName='$emp_middle_name',ats_employee_lastName='$emp_last_name',
        ats_employee_address='$emp_address',ats_employee_city='$emp_city',ats_employee_state='$emp_state',ats_employee_phoneNumber='$emp_phone',ats_employee_cellPhoneNumber='$emp_cell_phone',ats_employee_alternateNumber='$emp_alt_phone',ats_employee_dob='$emp_date_of_birth',
        ats_employee_pob='$emp_place_of_birth',ats_employee_nationality='$emp_nationality',ats_employee_cnicNo='$emp_cnic_no',ats_employee_cnicExpiry='$emp_cnic_expiry',ats_employee_email='$emp_email',ats_employee_relation='$emp_relationship_status',ats_employee_gender='$emp_gender',ats_employee_emergencyContact1_name='$emp_emergency_contact_person_name',ats_employee_emergencyContact1_phone='$emp_emergency_contact_person_phone',ats_employee_emergencyContact1_relation='$emp_emergency_contact_person_relation',ats_employee_emergencyContact2_name='$emp_emergency_contact_person_name_2',ats_employee_emergencyContact2_phone='$emp_emergency_contact_person_phone_2',ats_employee_emergencyContact2_relation='$emp_emergency_contact_person_relation_2',ats_employee_education1_name='$emp_institute_name',ats_employee_education1_degree='$emp_degree',ats_employee_education1_year='$emp_degree_year',ats_employee_education1_status='$emp_degree_status',ats_employee_education2_name='$emp_institute_name_2',ats_employee_education2_degree='$emp_degree_2',ats_employee_education2_year='$emp_degree_year_2',ats_employee_education2_status='$emp_degree_status_2',ats_employee_education3_name='$emp_institute_name_2',ats_employee_education3_degree='$emp_degree_2',ats_employee_education3_year='$emp_degree_year_3',ats_employee_education3_status='',ats_employee_Institute1_name='$emp_certification_institute_name',ats_employee_Institute1_level='$emp_level',ats_employee_Institute1_year='$emp_level_year',ats_employee_Institute1_status='$emp_certification_status',ats_employee_Institute2_name='$emp_certification_institute_name_2',ats_employee_Institute2_level='$emp_level_year_2',ats_employee_Institute2_year='$emp_level_year_2',ats_employee_Institute2_status='$emp_certification_status_2',ats_employee_Institute3_name='$emp_certification_institute_name_3',ats_employee_Institute3_level='$emp_level_year_2',ats_employee_Institute3_year='$emp_level_year_2', ats_employee_Institute3_status='$emp_certification_status_3',ats_employee_experience1_company='$emp_experience_company_name',ats_employee_experience1_position='$emp_experience_position',ats_employee_experience1_year='$emp_experience_year',ats_employee_experience1_department='$emp_experience_department',ats_employee_experience2_company='$emp_experience_company_name_2',ats_employee_experience2_position='$emp_experience_position',ats_employee_experience2_year='$emp_experience_year',ats_employee_experience2_department='$emp_experience_department_2',ats_employee_experience3_company='$emp_experience_company_name_3',ats_employee_experience3_position='$emp_experience_position_3',ats_employee_experience3_year='$emp_experience_year_3',ats_employee_experience3_department='$emp_experience_department_3',ats_employee_designation='$emp_designation',ats_employee_department='$emp_department',ats_employee_dateOfJoin='$emp_date_of_joining',ats_employee_type='$emp_type',ats_employee_payroll='$emp_payroll',ats_employee_basicSalary='$emp_basic_salary',ats_employee_profit='$emp_profit_share_percentage',ats_employee_comission='$emp_commision_per_unit',ats_employee_project='$emp_project',ats_employee_region='$emp_region',ats_employee_category='$emp_category',ats_employee_shift='$emp_shift',ats_employee_timing='$emp_timing',ats_employee_status='$emp_status',ats_employee_lastWorkingDate='$emp_last_working_date',region2='$emp_region2',region3='$emp_region3',region4='$emp_region4',region5='$emp_region5',emp_timing_till='$emp_timing1' WHERE ats_employee_id='".$id."'";$query = mysqli_query($connection,$insert);
        if ($query){
...
?>
                                                            ...
                                                            <div class="form-row">
                                                                <div class="col-md-3">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-3">
                                                                                <input type="text" value="ATS- " style="margin-left:20px;font-size:18px;border:none;margin-top:3px" readonly disabled>
                                                                            </div>
                                                                            <div class="col-md-9">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input name="emp_first_name" id="emp_first_name" placeholder="First Name" type="text" class="form-control" value="<?php echo $rowemp['ats_employee_firstName'] ?>" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="position-relative form-group">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input name="emp_last_name" id="emp_last_name" placeholder="Last Name" type="text" class="form-control" value="<?php echo $rowemp['ats_employee_lastName'] ?>" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input name="emp_address" id="emp_address" placeholder="Apartment, Studio, or Floor" type="text" class="form-control" value="<?php echo $rowemp['ats_employee_address'] ?>" required> 
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="position-relative form-group">
                                                                        <label>City<span style="color:red">*</span></label>
                                                                        <input name="emp_city" id="emp_city" placeholder="City Name" type="text" class="form-control" value="<?php echo $rowemp['ats_employee_city'] ?>" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="position-relative form-group">
                                                                        <label>State<span style="color:red">*</span></label>
                                                                        <input name="emp_state" id="emp_state" placeholder="State Name" type="text" class="form-control" value="<?php echo $rowemp['ats_employee_state'] ?>" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="position-relative form-group">
                                                                        <label>Phone Number</label>
                                                                        <input name="emp_phone" id="emp_phone" class="form-control" value="<?php echo $rowemp['ats_employee_phoneNumber'] ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input name="emp_cell_phone" id="emp_cell_phone" placeholder="0312-3456789" type="number" class="form-control" value="<?php echo $rowemp['ats_employee_cellPhoneNumber'] ?>" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="position-relative form-group">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input type="text" class="form-control input-mask-trigger" name="emp_date_of_birth" id="emp_date_of_birth" value="<?php echo $rowemp['ats_employee_dob'] ?>" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" required/>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="position-relative form-group">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input name="emp_nationality" placeholder="Enter Nationality" id="emp_nationality" type="text" class="form-control" value="<?php echo $rowemp['ats_employee_nationality'] ?>" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input id="emp_cnic_no" name="emp_cnic_no" placeholder="XXXXX-XXXXXXX-X" class="form-control masked" data-charset="XXXXX-XXXXXXX-X" type="text" value="<?php echo $rowemp['ats_employee_cnicNo'] ?>" required />            
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="position-relative form-group">
                                                                        <label style="font-weight: bold;" class="text-dark">CNIC Expiry<span style="color:red">*</span></label>
                                                                        <input type="text" class="form-control input-mask-trigger" name="emp_cnic_expiry" id="emp_cnic_expiry" value="<?php echo $rowemp['ats_employee_cnicExpiry'] ?>" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" required/>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                        <label>Email<span style="color:red">*</span></label>
                                                                        <input name="emp_email" id="emp_email" type="email" placeholder="someone@abc.com" class="form-control" value="<?php echo $rowemp['ats_employee_email'] ?>" onkeyup="sync()" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="position-relative form-group">
                                                                        <label>Username <span style="color:red">*</span><span style="font-size: 11px; color: grey;"></span></label>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                        <label>Photo <span style="color:red">*</span></label><span style="font-size: 11px; color: grey;">(Upload Passport Size Picture)</span></label>
                                                                        <input name="emp_passport_image" id="emp_passport_image" type="file" onchange="loadFile(event)" >
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                        <label>CNIC<span style="color:red">*</span><span style="font-size: 11px; color: grey;">(Upload CNIC Picture Front and Back Side)</span></label> <br/>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                        <label>Residential Docs <span style="color:red">*</span><span style="font-size: 11px; color: grey;">(Upload Picture of Utility Bills)</span></label>
                                                                    ...
                                                                    <div data-parent="#accordion" id="collapseTwo" class="collapse show">
                                                                        <div class="card-body">
                                                                            <div class="form-row">
                                                                                ...
                                                                                <div class="col-md-3">
                                                                                    <div class="position-relative form-group">
                                                                                        <label>Intitute Name<span style="color:red">*</span></label>
                                                                                        <input name="emp_institute_name" id="emp_institute_name" type="text" placeholder="Enter Institue Name" class="form-control" value="<?php echo $rowemp['ats_employee_education1_name'] ?>" required>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-3">
                                                                                    <div class="position-relative form-group">
                                                                                        <label>Degree<span style="color:red">*</span></label>
                                                                                        <input name="emp_degree" id="emp_degree" placeholder="Enter Degree Name" type="text" class="form-control" value="<?php echo $rowemp['ats_employee_education1_degree'] ?>" required>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-3">
                                                                                    <div class="position-relative form-group">
                                                                                        <label>Year<span style="color:red">*</span></label>
                                                                                        <input name="emp_degree_year" id="emp_degree_year" placeholder="Enter Degree Year" type="text" class="form-control" value="<?php echo $rowemp['ats_employee_education1_year'] ?>" required>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-3">
                                                                                    <div class="position-relative form-group">
                                                                                ...
                                                                                <div class="col-md-3">
                                                                                    <div class="position-relative form-group">
                                                                                        <label>Intitute Name<span style="color:red">*</span></label>
                                                                                        <input name="emp_institute_name_2" id="emp_institute_name_2" type="text" placeholder="Enter Institue Name" class="form-control" value="<?php echo $rowemp['ats_employee_education2_name'] ?>" required>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-3">
                                                                                    <div class="position-relative form-group">
                                                                                        <label>Degree<span style="color:red">*</span></label>
                                                                                        <input name="emp_degree_2" id="emp_degree_2" placeholder="Enter Degree Name" type="text" class="form-control" value="<?php echo $rowemp['ats_employee_education2_degree'] ?>" required>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-3">
                                                                                    <div class="position-relative form-group">
                                                                                        <label>Year<span style="color:red">*</span></label>
                                                                                        <input name="emp_degree_year_2" id="emp_degree_year_2" placeholder="Enter Degree Year" type="text" class="form-control" value="<?php echo $rowemp['ats_employee_education2_year'] ?>" required>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-3">
                                                                                    <div class="position-relative form-group">
                                                                            ...
                                                                            <div class="form-row">
                                                                                ...
                                                                                <div class="col-md-4">
                                                                                    <div class="position-relative form-group">
                                                                                        <label>Educational Docs <span style="color:red">*</span><span style="font-size: 11px; color: grey;">(Upload Educational Documents)</span></label>
                                                                                        <input  multiple="multiple" name="fileedu[]" id="emp_edu_docs" type="file" >
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <div class="position-relative form-group">
                                                                                        <label>Experience letter Docs <span style="font-size: 11px; color: grey;">(Upload Experience letter)</span></label>
                                                                                        <input  multiple="multiple" name="fileexp[]" id="emp_exp_docs" type="file">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <div class="position-relative form-group">
                                                                                        <label>Other Docs <span style="font-size: 11px; color: grey;">(Upload Other Documents)</span></label>
 ...
 class="collapse show">
                                                                        <div class="card-body">
                                                                            <div class="form-row">
                                                                                <div class="col-md-3">
                                                                                    <div class="position-relative form-group">
                                                                                        ...
                                                                                        <input name="emp_designation" id="emp_designation" type="text" class="form-control" value="<?php echo $rowemp['ats_employee_designation'] ?>" required>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <div class="position-relative form-group">
                                                                                ...
                                                                                <div class="col-md-3">
                                                                                    <div class="position-relative form-group">
                                                                                        ...
                                                                                        <input name="emp_commision_per_unit" id="emp_commision_per_unit" placeholder="Enter Commission / Unit" type="text" class="form-control text-left input-mask-trigger" data-inputmask="'alias': 'decimal', 'groupSeparator': ',', 'autoGroup': true" im-insert="true" value="<?php echo $rowemp['ats_employee_comission'] ?>">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-3">
                                                                                    <div class="position-relative form-group">
                                                                            ...
                                                                            <div class="row" id="regiondb">
                                                                                ...
                                                                                <div class="col-md-4">
                                                                                    ...
                                                                                    <div class="position-relative form-group row">
                                                                                        <div class="col-md-6">
                                                                                            <input style="width:160px;" name="emp_timing" id="emp_timing" type="time" class="form-control" required value="<?php echo $rowemp['ats_employee_timing'] ?>" required>
                                                                                            <p class="text-muted" >&nbsp;From</span>
                                                                                        </div>
                                                                                        <div class="col-md-6">
                                                                                            <input name="emp_timing1" id="emp_timing1" type="time" class="form-control" required  value="<?php echo $rowemp['emp_timing_till'] ?>" required>
                                                                            ...
                                                                            <input type="submit" class="btn-shadow btn-wide float-right btn-hover-shine btn btn-info mb-2" value="Update" name="btnsubmit" onclick="myFunction()">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
...
<script>     
    function myFunction() {
        ...
        if ( emp_first_name.value == "" || emp_last_name.value == "" || emp_address.value == "" || emp_city.value == "" || emp_state.value == "" || emp_phone.value == "" || emp_date_of_birth.value == "" ||  emp_nationality.value == "" || emp_cnic_no.value == "" || emp_cnic_expiry.value == "" || emp_email.value == "" || emp_relationship_status.value == "" || emp_gender.value == "" ||emp_institute_name.value == "" || emp_degree.value == "" || emp_degree_year.value == "" || emp_degree_status.value == "" || emp_designation.value == "" || emp_department.value == "" || emp_date_of_joining.value == "" || emp_type.value == "" || emp_payroll.value == "" || emp_project.value == "" || emp_region.value == "" || emp_category.value == "" || emp_shift.value == "" || emp_timing.value == "" || emp_status.value == "" ) {
