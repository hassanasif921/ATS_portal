    ...
    <table style="font-size: 8px;" class="table" id="myTable">
                                                            ...
                                                            <tbody>
                                                                <?php 
                                                                    ...
                                                                    {
                                                                        $querycar=mysqli_fetch_row(mysqli_query($connection,"select * from ats_car_stock where ats_car_stock_rec_no='".$rowreserved[1]."' AND ats_car_stock_ship_ok_date<>'' AND ats_car_stock_ship_ok_date BETWEEN '$get_reservedreports_date' AND '$get_reservedreports_till' "));
                                                                        if($querycar >0)
                                                                        {
                                                                ?>
                                                                <tr>
