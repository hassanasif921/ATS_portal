...
if (isset($_POST["btn_amendment_add"])) {
    ...
    $insert = "insert into ats_amendment(ats_amendment_rec_no,ats_amendment_maker,ats_amendment_chassis,ats_amendment_year,ats_amendment_consignee_name,ats_amendment_consignee_address,ats_amendment_consignee_tel,ats_amendment_consignee_fax,ats_amendment_noti_party_name,ats_amendment_notify_party_adres,ats_amendment_party_tel,ats_amendment_party_fax,ats_amendment_created_at,ats_amendment_updated_at,ats_amendment_status)values('$get_amendment_stock_rec_no','$get_amendment_stock_maker_modal','$get_amendment_stock_chassis_id','$get_amendment_stock_man_year','$amendment_consignee_name','$amendment_consignee_address','$amendment_consignee_phone_no','$amendment_consignee_fax_no','$amendment_consignee_notify_name','$amendment_consignee_notify_address','$amendment_consignee_notify_phone_no','$amendment_consignee_notify_fax_no','$amendment_consignee_createdAt','$amendment_consignee_updatedAt','$amendment_consignee_status')";
