                        ...
                        <div  style="margin-top: -1.2%; box-shadow: none; " class="app-inner-layout__wrapper row-fluid no-gutters">
                            <div class="tab-content app-inner-layout__content card">
                                    ...
                                    <form action="" method="">    
                                        <div style="background:darkgray; padding-top: 2%; padding-bottom: 0.5%;" class="row">
                                            ...
                                            <div style="margin-left: -8%; "class="col-sm-1">
                                                <select style="width: 160px;" name="get_all_rel_paid_agent_name" id="get_all_rel_paid_agent_name" type="text" class="form-control form-control-sm">
                                            ...
                                            <div style="margin-left: -6%;" class="col-sm-1 ">
                                                <select style="width: 160px;" name="get_all_rel_paid_customer_name" id="get_all_rel_paid_customer_name" type="text" class="form-control form-control-sm">
                                            ...
                                            <div style="margin-left: -2%;" class="col-sm-2">
                                                <select  name="get_all_rel_paid_country_name" id="get_all_rel_paid_country_name" required class="form-control form-control-sm">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input style="width: 100px;" type="submit" name="btn_all_rel_paid_search" id="btn_all_rel_paid_search" class="mb-2 mr-2 btn btn-gradient-success   " value="Search"> 
                                            </div>
                                            ...
                                            <div  class="col-sm-6">
                                                <input style="margin-left: -89px;" name="get_all_rel_paid_date" id="get_all_rel_paid_date" class="form-control form-control-sm js-daterangepicker"  >
                                            </div>
                                            <div class="col-sm-2"></div>    
                                        </div>     
                                    </form>
                                ...
                                <div style="margin-left: -19px;" class="container">
                                    <h5 class="text-center mt-2 text-primary">All Release Paid Cars</h5>
                                    <div class="row">
                                        <div class="col-lg-12">
