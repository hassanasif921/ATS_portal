...
if (isset($_POST["btnsubmit"])) {
    ...
    '$emp_certification_institute_name','$emp_level','$emp_level_year','$emp_certification_status','$emp_certification_institute_name_2','$emp_level_2','$emp_level_year_2','$emp_certification_status_2','$emp_certification_institute_name_3','$emp_level_3','$emp_level_year_3','$emp_certification_status_3', '$emp_experience_company_name','$emp_experience_position','$emp_experience_year','$emp_experience_department','$emp_experience_company_name_2','$emp_experience_position_2','$emp_experience_year_2','$emp_experience_department_2','$emp_experience_company_name_3','$emp_experience_position_3','$emp_experience_year_3','$emp_experience_department_3','$emp_designation','$emp_department','$emp_date_of_joining','$emp_type','$emp_payroll','$emp_basic_salary','$emp_profit_share_percentage','$emp_commision_per_unit','$emp_project','$emp_region','$emp_category','$emp_shift','$emp_timing','$emp_status','$emp_last_working_date','','$emp_createdBy','$emp_createdAt','$emp_updatedBy','$emp_updatedAt','$emp_region2','$emp_region3','$emp_region4','$emp_region5','$emp_timing1','$emp_username','$emp_password')";
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-md-3">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <div style="margin-bottom:-16px;" class="form-row">
                                                                        <div class="col-sm-2">
                                                                            <input type="text" value="ATS-" style="font-size:18px;border:none;margin-top:3px" disabled>
                                                                        </div>
                                                                        <div class="col-sm-10">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <input id="emp_cnic_no" name="emp_cnic_no" placeholder="XXXXX-XXXXXXX-X" class="form-control masked" data-charset="XXXXX-XXXXXXX-X" type="text" required/>          
                                                                        ...
                                                                        <div  data-parent="#accordion_contact" id="collapseOne10" aria-labelledby="headingOne1" class="collapse ">
                                                                            <div class="card-body row">
                                                                                ...
                                                                                <div class="col-md-4">
                                                                                    <div class="position-relative form-group">
                                                                                        <label class="text-dark">Phone No.</label>
                                                                                        <input name="emp_emergency_contact_person_phone_2" id="emp_emergency_contact_person_phone_2" placeholder="XXXX-XXX-XXXXXXX" class="form-control masked" data-charset="XXXX-XXX-XXXXXXX" type="text"/>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <div class="position-relative form-group">
                                                                            ...
                                                                            <div class="card-body">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div style="margin-top: 0.5%;" class="col-md-6">
                                                                                            <div id="dvPreview" class="col-md-12"></div>
                                                                                            </br>
                                                                                            <div id="dvPreviewres" class="col-md-12"></div>
                                                                                            </br>
                                                                                            <div id="dvPreviewedu" class="col-md-12"></div>
                                                                                            </br>
                                                                                            <div id="dvPreviewexp" class="col-md-12"></div>
                                                                                            </br>
                                                                                            <div id="dvPreviewodc" class="col-md-12"></div>
                                                                                        </div> 
                                                                                    </div>
                                                                                </div>
                                                                            </div>
