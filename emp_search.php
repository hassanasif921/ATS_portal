                                ...
                                <div style="box-shadow: none;" class=" container card">
                                    <form action="" method="">    
                                        <div style="background:darkgray; padding-top: 2%;" class="row">
                                          ...
                                          <div class="col-sm-2">
                                            <input name="get_emp_id_ag" id="get_emp_id_ag" style="margin-left: -35%;" class="form-control-sm form-control text-left"onkeyup="myFunction1()">
                                          </div>
                                        ...
                                        <div class="row">
                                            <div style="margin-left: 6.5%;" class="col-lg-12">
                                                <div class="main-card card">
                                                    <div class="card-body">
                                                        <div style="height:440px;" class="table-responsive table-hover tableFixHead">
