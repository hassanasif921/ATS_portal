                                    ...
                                    <div class="card-body">
                                        <form action="" method="post" enctype="multipart/form-data">    
                                            <div style="margin-top: -1%" class="row form-group">
                                                <div class="col-sm-2">
                                                    ...
                                                    <div style="margin-bottom:-16px;" class="form-row">
                                                            <div class="col-sm-4">
                                                                  <input  type="text" class="" value="ATS-CUS&nbsp; &nbsp;" style="font-size:12px;border:none;margin-top:12.5%;"  disabled>
                                                            </div>
                                                            <div class="col-sm-8">
                                                                  <input type="text" id="cus_company_id" name="cus_company_id" value="<?php echo $rowcust['Auto_increment']; ?>" class="form-control-sm form-control" style="pointer-events: none"></div>
                                            ...
                                            <div style="margin-top: -2%" class="row form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="form-group"><label class="form-control-label">Country<span style="color:red">*</span></label>
                                                    ...
                                                    <div style="width: 103%" data-parent="#accordion_another_contact" id="collapseOne3" aria-labelledby="headingOne1" class="collapse ">
                                                        <div class="row form-group mt-2 mb-0 ">
                                                            ...
                                                            <div style="width: 97%; margin-top: -0.8% ; margin-left: 1.5%" id="accordion_another_contact2">
                                                                    <div id="headingOne12" >
                                                                        <a href="" data-toggle="collapse" class="text-link" data-target="#collapseOne31" aria-expanded="true" aria-controls="collapseOne1" class="text-left btn btn-link btn-block">
                                                                            + Add another Contact Person Detail
                                                                        </a>
                                                                    </div>
