                                ...
                                <div style="box-shadow: none;" class=" container card">
                                    <form action="" method="">    
                                        <div style="background:darkgray; padding-top: 2%;" class="row">
                                                ...
                                                <div class="col-sm-2 ">
                                                    <input style="margin-left: -20%;" name="get_stock_make_usa" id="get_stock_make_usa"  type="text" class="form-control form-control-sm">
                                                </div>
                                                <div style="margin-left: -3%;" class="col-sm-1">
                                                    <label style=" font-weight: bold; margin-top: 5px;" class="form-control-label">Model</label>
                                                </div>
                                                <div class="col-sm-2">
                                                    <input style="margin-left: -20%;" name="get_stock_modal_usa" id="get_stock_modal_usa"  type="text" class="form-control form-control-sm">
                                                </div>
                                                ...
                                                <div style="margin-left: -8%;" class="col-sm-2">
                                                    <input name="get_stock_chassis_id_usa" id="get_stock_chassis_id_usa" type="text" class="form-control form-control-sm">
                                                </div>
                                                ...
                                                <div style="margin-left: 5%;" class="col-sm-1">
                                                    <input style="width: 100px;" type="submit" name="usa_search_btn" id="usa_search_btn" class="mb-2 mr-2 btn btn-gradient-success" value="Search"> 
                                                </div>
                                        </div> 
                                    </form>
                                </div>
