                                    ...
                                    <div class="card-body">
                                        <form action="" method="post">    
                                            <div style="margin-top: -1%" class="row form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                    <label class="form-control-label">Dealership Name</label>
                                            ...
                                            <div style="margin-top: -2%" class="row form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <input type="text" id="cus_password" name="cus_password" value="<?php echo $rowcupdate[6];?>" class="form-control form-control-sm" style="pointer-events: none" required></div>
                                                </div>
                                                <div class="col-sm-2">
                                            ...
                                            <div style="margin-top: -2%" class="row form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="cus_address" name="cus_address" value="<?php echo $rowcupdate[13]?>" placeholder="Enter Address" class="form-control form-control-sm" required style="pointer-events: none">
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="margin-top: -2%" class="row form-group">
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <label id="cus_company_phone" name="cus_company_phone" placeholder="Enter Company Phone #" class="form-control form-control-sm" required style="pointer-events: none"><?php echo $rowcupdate[14]?></label>
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label class="form-control-label">Home Phone #</label>
                                                        <input type="text" id="cus_home_phone" value="<?php echo $rowcupdate[15]?>" name="cus_home_phone" placeholder="Enter Home Phone #" class="form-control form-control-sm" style="pointer-events: none">
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label class="form-control-label">Personal Phone #</label>
                                                        <input type="text" id="cus_personal_phone" value="<?php echo $rowcupdate[16]?>" name="cus_personal_phone" placeholder="Enter Personal Phone #" class="form-control form-control-sm" style="pointer-events: none">
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label class="form-control-label">FAX #</label>
                                                        <input type="text" id="cus_fax" name="cus_fax" value="<?php echo $rowcupdate[17]?>" placeholder="Enter Fax Number #" class="form-control form-control-sm" style="pointer-events: none">
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="margin-top: -2%" class="row form-group">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label">Contact/Key Person 1</label>
                                                        <input type="text" name="cus_contact_key_1" id="cus_contact_phone_1" value="<?php echo $rowcupdate[30]?>" placeholder="Enter Person 1 Phone #" class="form-control form-control-sm" style="pointer-events: none">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label">Contact Person 1 Phone #</label>
                                                        <input type="text" name="cus_contact_phone_1" id="cus_contact_phone_1" value="<?php echo $rowcupdate[18]?>" placeholder="Enter Person 1 Phone #" class="form-control form-control-sm" style="pointer-events: none">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label">Contact Person 1 Email</label>
                                                        <input type="email" name="cus_contact_email_1" id="cus_contact_email_1" value="<?php echo $rowcupdate[19]?>" placeholder="Enter Person 1 Email" class="form-control form-control-sm" style="pointer-events: none">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div style="width: 100%; margin-top: -2.5%" id="accordion_another_contact">
                                                    <div style="width: 103%">
                                                        <div class="row form-group mt-2 mb-0 ">
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    <label class="form-control-label">Contact/Key Person 2</label>
                                                                    <input type="text" name="cus_contact_key_2" id="cus_contact_phone_2" value="<?php echo $rowcupdate[31]?>" placeholder="Enter Person 1 Phone #" class="form-control form-control-sm" style="pointer-events: none">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    <label class="form-control-label">Contact Person 2 Phone #</label>
                                                                    <input type="text" name="cus_contact_phone_2" id="cus_contact_phone_2" placeholder="Enter Person 2 Phone #" value="<?php echo $rowcupdate[20]?>" class="form-control form-control-sm" style="pointer-events: none">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    <label class="form-control-label">Contact Person 2 Email</label>
                                                                    <input type="email" name="cus_contact_email_2" id="cus_contact_email_2" value="<?php echo $rowcupdate[21]?>" placeholder="Enter Person 2 Email" class="form-control form-control-sm" style="pointer-events: none">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    <label class="form-control-label">Contact/Key Person 3</label>
                                                                    <input type="text" name="cus_contact_key_3" id="cus_contact_phone_3" value="<?php echo $rowcupdate[32]?>" placeholder="Enter Person 3 Phone #" class="form-control form-control-sm" style="pointer-events: none">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    <label class="form-control-label">Contact Person 3 Phone #</label>
                                                                    <input type="text" name="cus_contact_phone_3" id="cus_contact_phone_3" placeholder="Enter Person 3 Phone #" value="<?php echo $rowcupdate[22]?>" class="form-control form-control-sm" style="pointer-events: none">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    <label class="form-control-label">Contact Person 3 Email</label>
                                                                    <input type="email" name="cus_contact_email_3" id="cus_contact_email_3" value="<?php echo $rowcupdate[23]?>" placeholder="Enter Person 3 Email" class="form-control form-control-sm" style="pointer-events: none">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div style="margin-top: -1.5%" class="row form-group">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="<?php echo $rowcupdate[24]?>" name="cus_memo" id="cus_memo" placeholder="Enter Memo Detail" class="form-control form-control-sm" style="pointer-events: none">
                                                    </div>
                                                </div>
                                                 <div class="col-sm-4">
                                                    <div class="form-group"> 
