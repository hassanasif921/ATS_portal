...
$consignee_status = "active";
 ...
 ats_consignee_consignee_fax,ats_consignee_notify_party_name,ats_consignee_notify_party_adress,ats_consignee_notify_party_tel,ats_consignee_notify_fax,ats_consignee_created_at,ats_consignee_status)values('$consignee_agent_name','$consignee_customer_name','$consignee_country','$consignee_name',
             '$consignee_address','$consignee_phone_no','$consignee_fax_no',
             '$consignee_notify_name','$consignee_notify_address','$consignee_notify_phone_no',
             '$consignee_notify_fax_no','$consignee_created_At','$consignee_status')";
                                    ...
                                    <div class="col-md-4">
                                        <div class="position-relative form-group">
                                            ...
                                            <select name="consignee_agent_name"   id="consignee_agent_name" class="form-control">
                                                <option value="25">EmployeeTable</option>
