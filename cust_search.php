                                                            ...
                                                            <table class="table" id="myTable">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><a style="padding:3px" href="cust-view.php?id=<?php echo $row["ats_customer_ATS_ID"] ?>">View</a><button data-id="<?php echo $row['ats_customer_ATS_ID'] ?>" data-toggle="modal" data-target="#exampleModalLong" class='userinfo btn btn-warning'>Changes</button></td>
                                                                    </tr>
                                                                    <?php
                                                                            }    
                                                                        }
