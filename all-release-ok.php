                                                    ...
                                                    <table style="font-size: 8px;" class="table" id="myTable">
                                                            ...
                                                            <tbody>
                                                                <?php 
                                                                    ...
                                                                    {
                                                                        $querycar=mysqli_fetch_row(mysqli_query($connection,"select * from ats_car_stock where ats_car_stock_rec_no='".$rowreserved[1]."' AND ats_car_stock_release_ok_date<>'' "));
